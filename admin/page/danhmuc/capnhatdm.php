    ...
    <div class="form-scroll-container" style="background-color: white; padding: 20px; border-radius: 12px;">
        ...
        <div class="product-header-wrap">
            ...
            <div class="product-breadcrumb">
                <a href="<?php echo BASE_URL; ?>/page/danhmuc/danhsachdanhmuc.php">Danh Sách Danh Mục</a> / <span>Cập Nhật Danh Mục</span>
            </div>
        </div>
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="product-form-grid">
                ...
                <div class="product-field-group">
                    ...
                    <input type="text" name="category_code" class="product-input" value="DM-01" required>
                </div>

                <!-- Tên danh mục -->
                <div class="product-field-group">
                    <label>Tên danh mục</label>
                    <input type="text" name="category_name" class="product-input" value="iPhone" placeholder="Nhập tên danh mục..." required>
                </div>
                ...
                <div class="product-field-group span-4">
                    ...
                    <label class="btn-file-upload">
                        <i class="fa-solid fa-cloud-arrow-up"></i> Thay đổi ảnh mới
                ...
                <div class="product-field-group span-4">
                    ...
                    <textarea name="description" class="product-input" placeholder="Nhập mô tả chi tiết danh mục...">Các dòng điện thoại iPhone chính hãng Apple</textarea>
                </div>
            </div>
